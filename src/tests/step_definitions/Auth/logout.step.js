...
Then(
   'Tôi sẽ kiểm tra thời gian xử lý của endpoint API không được quá "{string}" milliseconds cho mỗi Request.',
   function (time) {
...
Then(
   "Nếu trạng thái phản hồi là 200, tôi sẽ nhận được thông báo logout thành công và kiểm tra dữ liệu trả về.",
   function () {
