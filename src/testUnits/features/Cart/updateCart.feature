Feature: Update Product Quantity in Cart
   ...
   Scenario Outline: Cập nhật số lượng sản phẩm trong giỏ hàng của người dùng bằng cách tăng lên 1
      ...
      When Tôi gửi yêu cầu HTTP PUT đến "/api/v1/carts/increaseQuantity" với dữ liệu cập nhật số lượng sản phẩm là 1 trong giỏ hàng của người dùng
   ...
   Scenario Outline: Cập nhật số lượng sản phẩm trong giỏ hàng của người dùng bằng cách giảm xuống 1
      ...
      When Tôi gửi yêu cầu HTTP PUT đến "/api/v1/carts/decreaseQuantity" để giảm số lượng sản phẩm trong giỏ hàng của người dùng xuống 1
